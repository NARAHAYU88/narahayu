...
<aside class="sidebar">
    ...
    <a class="menu active" onclick="showSection('beranda',this)">🏠 Beranda</a>
    <a class="menu" onclick="showSection('layanan',this)">💉 Layanan</a>
    <a class="menu" onclick="showSection('dokter',this)">👨‍⚕️ Dokter</a>
    <a class="menu" onclick="showSection('kontak',this)">📞 Kontak</a>
    <a class="menu" onclick="showSection('daftar',this)">📝 Pendaftaran</a>
    <a class="menu" onclick="showSection('data',this)">📊 Data Pasien</a>
</aside>
